  ...
  $(document).ready(function () {
    ...
    for (project in projects) {
      ...
      for (var i = 1; i < project.i; i++) {
        ind = i < 10 ? '0'+i : i;
        url = 'assets2/projects/'+project.p+'/screenshots/image'+ind+'.jpg';
        holder.slides.push({
          image : url,
          title : project.t,
        });
      ...
      if (project.e != true) {
        link = '<li class="tile"><a href="#"><img src="assets2/projects/'+project.p+'/preview/preview.jpg" alt="'+project.t+'" rel="'+pi+'"/><div class="details-wrapper"><div class="details"><h3 class="title">'+project.t+'</h3><p>'+project.d+'</p></div></div></a></li>';
        $('#gallery').append(link);
      }
