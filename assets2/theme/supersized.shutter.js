...
//	 		theme._setSliderAnimations();
		...
		progressBar : function(){
	 	...
	 	,show:function(){	 
	 		...
	 		var w = $('#prevslide').width();
	 		$('#prevslide').stop().animate({'left':0}, 500);
	 		$('#nextslide').stop().animate({'right':0}, 500);
	 		
	 		//$('li.prevslide').find('img').fadeIn(500);	
	 	...
	 	,hide:function(){
	 		...
	 		var w = $('#prevslide').width();
	 		$('#prevslide').stop().animate({'left':-w}, 500);
	 		$('#nextslide').stop().animate({'right':-w}, 500);
	 		
	 		//$('li.activeslide').find('img').fadeOut(500);	
	 	}
	 	,introImage:function(){	 		
	 		//$('li.prevslide').find('img').fadeIn(500);	
	 	}
	 ...
	 $.supersized.themeVars = {
		...
		image_path			:	'assets2/images/',				// Default image path
